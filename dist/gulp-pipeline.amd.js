define(['exports', 'gulp-autoprefixer', 'extend', 'gulp-if', 'gulp-debug', 'gulp-eslint', 'browser-sync', 'gulp-changed', 'gulp-imagemin', 'gulp-sass', 'gulp-sourcemaps', 'gulp-scss-lint', 'gulp-scss-lint-stylish', 'gulp-util', 'stringify-object', 'run-sequence', 'rollup', 'glob', 'rollup-plugin-babel', 'gulp-notify', 'del'], function (exports, autoprefixer, extend, gulpif, debug, eslint, BrowserSync, changed, imagemin, sass, sourcemaps, scssLint, scssLintStylish, Util, stringify, runSequence, rollup, glob, babel, notify, del) { 'use strict';
