(function (exports,autoprefixer,extend,gulpif,debug,eslint,BrowserSync,changed,imagemin,sass,sourcemaps,scssLint,scssLintStylish,Util,stringify,runSequence,rollup,glob,babel,notify,del) {
  'use strict';
...
}((this.gulpPipeline = {}),autoprefixer,extend,gulpif,debug,eslint,BrowserSync,changed,imagemin,sass,sourcemaps,scssLint,scssLintStylish,Util,stringify,runSequence,rollup,glob,babel,notify,del));
