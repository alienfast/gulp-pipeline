(function (exports,extend,path,glob,spawn,fs,jsonfile,Util,stringify,notify,gulpHelp,console,autoprefixer,gulpif,debug,eslint,BrowserSync,changed,imagemin,merge,sass,sourcemaps,findup,scssLint,scssLintStylish,rollup,nodeResolve,commonjs,process,babel,del,rev,cssnano,mocha,BuildControl,fs$1,pathIsAbsolute) {
  'use strict';
...
}((this.gulpPipeline = this.gulpPipeline || {}),extend,path,glob,spawn,fs,jsonfile,Util,stringify,notify,gulpHelp,console,autoprefixer,gulpif,debug,eslint,BrowserSync,changed,imagemin,merge,sass,sourcemaps,findup,scssLint,scssLintStylish,rollup,nodeResolve,commonjs,process,babel,del,rev,cssnano,mocha,BuildControl,fs$1,pathIsAbsolute));
