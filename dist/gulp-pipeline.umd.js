(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('gulp-autoprefixer'), require('extend'), require('gulp-if'), require('gulp-eslint'), require('gulp-debug'), require('glob'), require('browser-sync'), require('gulp-sass'), require('gulp-sourcemaps'), require('gulp-util'), require('gulp-scss-lint'), require('gulp-scss-lint-stylish'), require('rollup'), require('stringify-object'), require('rollup-plugin-babel'), require('gulp-notify')) :
  typeof define === 'function' && define.amd ? define(['exports', 'gulp-autoprefixer', 'extend', 'gulp-if', 'gulp-eslint', 'gulp-debug', 'glob', 'browser-sync', 'gulp-sass', 'gulp-sourcemaps', 'gulp-util', 'gulp-scss-lint', 'gulp-scss-lint-stylish', 'rollup', 'stringify-object', 'rollup-plugin-babel', 'gulp-notify'], factory) :
  (factory((global.gulpPipeline = {}),global.autoprefixer,global.extend,global.gulpif,global.eslint,global.debug$1,global.glob,global.BrowserSync,global.sass,global.sourcemaps,global.Util,global.scssLint,global.scssLintStylish,global.rollup,global.stringify,global.babel,global.notify));
}(this, function (exports,autoprefixer,extend,gulpif,eslint,debug$1,glob,BrowserSync,sass,sourcemaps,Util,scssLint,scssLintStylish,rollup,stringify,babel,notify) { 'use strict';
