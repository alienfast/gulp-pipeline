(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('gulp-autoprefixer'), require('extend'), require('gulp-eslint'), require('gulp-debug'), require('browser-sync'), require('gulp-sass'), require('gulp-sourcemaps'), require('gulp-util'), require('gulp-scss-lint'), require('gulp-scss-lint-stylish'), require('rollup'), require('glob'), require('stringify-object'), require('rollup-plugin-babel'), require('gulp-notify')) :
  typeof define === 'function' && define.amd ? define(['exports', 'gulp-autoprefixer', 'extend', 'gulp-eslint', 'gulp-debug', 'browser-sync', 'gulp-sass', 'gulp-sourcemaps', 'gulp-util', 'gulp-scss-lint', 'gulp-scss-lint-stylish', 'rollup', 'glob', 'stringify-object', 'rollup-plugin-babel', 'gulp-notify'], factory) :
  (factory((global.gulpPipeline = {}),global.autoprefixer,global.extend,global.eslint,global.debug,global.BrowserSync,global.sass,global.sourcemaps,global.Util,global.scssLint,global.scssLintStylish,global.rollup,global.glob,global.stringify,global.babel,global.notify));
}(this, function (exports,autoprefixer,extend,eslint,debug,BrowserSync,sass,sourcemaps,Util,scssLint,scssLintStylish,rollup,glob,stringify,babel,notify) { 'use strict';
